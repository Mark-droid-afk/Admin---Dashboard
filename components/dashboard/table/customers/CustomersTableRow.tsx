...
export default function CustomersTableRow({ row, selected, onToggleSelect }: CustomersTableRowProps) {
  return (
    <tr className="border-b border-neutral-800 dark:border-neutral-600 text-sm last:border-b-0">
      <td className="text-md px-4 py-4 font-medium text-neutral-600 dark:text-neutral-300">{row.customer}</td>
      <td className="text-md px-4 py-4 text-neutral-600 dark:text-neutral-300">{row.email}</td>
      <td className="text-md px-4 py-4 text-neutral-600 dark:text-neutral-300">{row.phone}</td>
      <td className="text-md px-4 py-4 text-neutral-600 dark:text-neutral-300">
